...
void printLCDNumber(int num){
  ...
  if (dig4 != 48)      {writeLCDValue(dig4, TYPE_CHAR);writeLCDValue(dig3, TYPE_CHAR);writeLCDValue(dig2, TYPE_CHAR);writeLCDValue(dig1, TYPE_CHAR);writeLCDValue(dig0, TYPE_CHAR); linePosition+=5;} 
  else if (dig3 != 48) {writeLCDValue(dig3, TYPE_CHAR);writeLCDValue(dig2, TYPE_CHAR);writeLCDValue(dig1, TYPE_CHAR);writeLCDValue(dig0, TYPE_CHAR); linePosition+=4;} 
  else if (dig2 != 48) {writeLCDValue(dig2, TYPE_CHAR);writeLCDValue(dig1, TYPE_CHAR);writeLCDValue(dig0, TYPE_CHAR); linePosition+=3;} 
  else if (dig1 != 48) {writeLCDValue(dig1, TYPE_CHAR);writeLCDValue(dig0, TYPE_CHAR); linePosition+=2;} 
  else {                writeLCDValue(dig0, TYPE_CHAR); linePosition++; }
}
